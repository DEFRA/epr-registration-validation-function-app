...
public struct IncorporationTypeCodes
{
    ...
    public static readonly string LimitedPartnership = "LPA";
    public static readonly string PublicLimitedCompany = "PLC";
    public static readonly string CommunityInterestCompany = "CIC";
}