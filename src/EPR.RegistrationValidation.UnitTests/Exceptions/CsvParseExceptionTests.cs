...
#pragma warning disable SYSLIB0050 // Type or member is obsolete
        var info = new SerializationInfo(typeof(CsvParseException), new FormatterConverter());
#pragma warning restore SYSLIB0050 // Type or member is obsolete
        info.AddValue("ClassName", typeof(CsvParseException).FullName);
        ...
        // Act
        var exception = (CsvParseException)Activator.CreateInstance(
            typeof(CsvParseException),
